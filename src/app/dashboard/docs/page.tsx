      ...
      <div className="max-w-4xl mx-auto space-y-10 pb-12">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <h1 className="font-heading text-3xl font-bold">Getting Started</h1>
          ...
          <CardContent className="p-0">
            <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 dark:from-slate-950 dark:to-slate-900 rounded-xl overflow-hidden aspect-video flex items-center justify-center">
              ...
              <div className="relative text-center">
                ...
                <h3 className="font-heading font-bold text-white text-lg mb-1">Video Tutorial</h3>
                <p className="text-white/60 text-sm">Full walkthrough coming soon</p>
                <Badge className="mt-3 bg-teal-500/20 text-teal-300 border-teal-500/30 hover:bg-teal-500/20">
        ...
        {/* Still need help */}
        <Card className="bg-gradient-to-r from-teal-50 to-emerald-50 dark:from-teal-950/30 dark:to-emerald-950/30 border-teal-200/60 dark:border-teal-800/60">
          <CardContent className="p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
            <div>
              <h3 className="font-heading font-bold mb-1">Still have questions?</h3>
