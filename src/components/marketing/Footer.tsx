...
export function Footer() {
  return (
    <>
      ...
      <div className="border-t bg-gradient-to-r from-teal-500/10 via-background to-teal-500/10 py-3">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-center text-sm font-medium text-foreground">
            <span aria-hidden="true">🇮🇳</span> Made in India · Built for Indian
            SMBs · Play Store + Google ready
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-sm text-navy-400 max-w-md mb-4">
                AI review management for Indian local businesses and app
                developers. Reply to Google Business Profile and Play Store
                reviews in seconds. Plans from ₹1,500/month — roughly 17×
                cheaper than global alternatives.
              </p>
