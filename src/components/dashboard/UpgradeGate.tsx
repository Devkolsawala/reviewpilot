    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-white dark:bg-gray-900 border rounded-xl p-6 text-center shadow-lg max-w-sm">
          ...
          <a href="/dashboard/settings/billing" className="inline-block bg-teal-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-teal-600">Upgrade Plan</a>
        </div>
      </div>
    </div>
  );
