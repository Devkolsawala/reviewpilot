  ...
  return (
    <button
      ...
      className={cn(
        ...
        selected && "bg-teal-50/60 dark:bg-teal-950/20 border-l-[3px] border-l-teal-500 pl-[13px]",
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            {review.is_auto_replied && (
              <span className="inline-flex items-center gap-0.5 rounded-full bg-teal-100 dark:bg-teal-950/40 px-1.5 py-0 text-[10px] font-medium text-teal-700 dark:text-teal-400">
