...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    icon: <Inbox className="h-6 w-6 text-teal-500" />,
    position: "left",
  },
  {
    title: "Review Inbox",
  ...
  },
  {
    ...
    icon: <Megaphone className="h-6 w-6 text-teal-500" />,
    position: "center",
  },
  {
    ...
    <div className="fixed inset-0 z-[100]">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-6">
        <div className="relative bg-card rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in-95 duration-200">
          ...
          {/* Header gradient */}
          <div className="bg-gradient-to-br from-teal-500/10 to-emerald-500/10 dark:from-teal-500/5 dark:to-emerald-500/5 px-8 pt-8 pb-4 flex justify-center">
            <div className="rounded-2xl bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-teal-950/40 dark:to-emerald-950/40 p-5">
              {currentStep.icon}
            </div>
          </div>
          ...
          <div className="px-8 py-6 text-center">
            <h3 className="font-heading text-xl font-bold mb-2">{currentStep.title}</h3>
            ...
            {TOUR_STEPS.map((_, i) => (
              <button
                ...
                className={`h-1.5 rounded-full transition-all duration-200 ${
                  i === step ? "w-6 bg-teal-500" : "w-1.5 bg-border hover:bg-muted-foreground/30"
                }`}
              />
            ))}
          </div>
