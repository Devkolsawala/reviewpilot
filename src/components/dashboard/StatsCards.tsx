    ...
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <Card className="relative overflow-hidden">
        <CardContent className="p-5">
          ...
          <div className="flex items-end gap-2">
            <AnimatedCounter value={totalReviews} className="text-3xl font-bold font-heading" />
          ...
          <div className="flex items-end gap-[3px] mt-3 h-8">
            {[4, 6, 5, 8, 7, 9, 6, 8, 10, 7, 9, 11].map((v, i) => (
              <div
                key={i}
                className="flex-1 rounded-sm bg-teal-200 dark:bg-teal-800"
      ...
      <Card className="relative overflow-hidden">
        <CardContent className="p-5">
          ...
          <div className="flex items-end gap-2">
            <AnimatedCounter value={avgRating} decimals={1} className="text-3xl font-bold font-heading" />
      ...
      <Card className="relative overflow-hidden">
        <CardContent className="p-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <AnimatedCounter value={responseRate} suffix="%" className="text-3xl font-bold font-heading" />
      ...
      <Card className="relative overflow-hidden">
        <CardContent className="p-5">
          ...
          <div className="flex items-end gap-2">
            <AnimatedCounter value={pendingCount} className="text-3xl font-bold font-heading" />
            {pendingCount > 0 && (
