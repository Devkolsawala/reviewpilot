 ...
 *
 * Static map (no runtime dependency on a country-name library). Used by the
 * Play Store country filter in the Review Inbox. Names are short common
 * English forms; flags are standard Unicode regional-indicator pairs.
 */
export const COUNTRIES: Record<string, { name: string; flag: string }> = {
  ...
  HM: { name: "Heard & McDonald Islands", flag: "🇭🇲" },
